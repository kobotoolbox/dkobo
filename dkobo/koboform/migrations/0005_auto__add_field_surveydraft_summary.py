...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyDraft.summary'
        db.add_column(u'koboform_surveydraft', 'summary',
                      self.gf('django.db.models.fields.TextField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyDraft.summary'
        db.delete_column(u'koboform_surveydraft', 'summary')
