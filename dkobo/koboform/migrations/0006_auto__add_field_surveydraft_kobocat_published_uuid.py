...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyDraft.kobocat_published_uuid'
        db.add_column(u'koboform_surveydraft', 'kobocat_published_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyDraft.kobocat_published_uuid'
        db.delete_column(u'koboform_surveydraft', 'kobocat_published_uuid')
