      ...
      """
        <div class="sub-header-bar">
          <div class="container__wide">
            ...
            <button class="btn btn--utility" id="save-quit"><i class="fa fa-check-circle green"></i> Save and Exit #{type_name}</button>
            ...
            <button class="btn btn--utility js-close bleeding-edge"><i>X</i></button>
            <button class="btn btn--utility js-save bleeding-edge"><i class="fa fa-fw fa-save"></i></button>
