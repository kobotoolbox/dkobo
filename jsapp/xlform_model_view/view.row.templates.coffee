define 'cs!xlform/view.row.templates', [], ()->
  ...
  rowErrorView = (atts)->
    ...
    <div class="card card--error">
      ...
      <em>This question could not be imported. Please re-create it manually. Please contact us at <a href="mailto:support@kobotoolbox.org">info@kobotoolbox.org</a> so we can fix this bug!</em>
    </div>
    #{expandingSpacerHtml}
    """
