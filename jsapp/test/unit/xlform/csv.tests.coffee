define [
  ...
  describe "individual methods", ->
    ...
    it "properly outputs results of csv._objPattern", ->
      expect(csv.toArray("aa,bb,cc")[0]).toEqual(["aa", "bb", "cc"])

    it "properly outputs results of csv.toArray", ->
      simpleCsv = "col1,col2\nxxxx,yyyy";
      expect(csv.toArray(simpleCsv)).toEqual([["col1", "col2"], ["xxxx", "yyyy"]])
